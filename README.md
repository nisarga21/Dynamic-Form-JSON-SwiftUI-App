...
1. Open `DynamicFormApp.xcodeproj` in Xcode 14+ (iOS 15+).
2. Build and run on simulator or device.
3. The sample JSON in `ContentView` demonstrates all features. You can edit the JSON to test edge cases.
4. Run unit tests with `Cmd+U`.

---

## Demo Video

[Link to short video (30‑60 seconds) showing:  
- Loading the sample form  
- Editing text, dropdowns, checkbox with clickable links  
- Validation errors appearing in real time  
- Keyboard “Next” / “Done” toolbar  
...
This project was developed with assistance from **DeepSeek** (AI). The AI contributed:
- Full code structure and implementation
- Polymorphic JSON decoding logic
- SwiftUI view components and focus management
- Unit tests and README content

The collaboration log (`AI_COLLABORATION_LOG.md`) records every exchange in this thread.

---

## Repository Link

[Public Git repository URL – insert your link here]